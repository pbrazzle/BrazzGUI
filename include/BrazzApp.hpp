...
class BrazzApp {
     ...
     * When this BrazzApp receives an Event with the same type and id as the
     * template, it will run the connected callback functions. An Event template
     * can be connected to multiple callbacks.
     *
